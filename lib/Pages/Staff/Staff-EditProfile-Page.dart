                  ...
                  child: TextButton(
                    ...
                    onPressed: () async {
                      if (_formKey.currentState!.validate()) {
                        ...
                        staffModel.fullName = _nameText.text;
                        staffModel.contactNumber = _contactText.text;
                        staffModel.address = _addressText.text;
                        ...
                        context.read<SignUpSignInControllerStaff>().editProfile(
                            currentUser[0]['uid'], imageUrl, staffModel, context);
